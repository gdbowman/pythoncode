...
format of the input is expected to be a simple 2-column CSV file, where the two numbers are separated by a comma. The first 
...
To run this script, the pdb file itself is not needed, just a 2-column CSV file, with residue numbers in first column and
...
python3 makepymolscript-color-DNAchainduplex-by-2columnCSV-[version].py DNAparameterfile.csv
...
print()
print("Usage: ")
print("python3 thisscript.py DNAparameterfile.csv ")
print()
print("#"*60)
